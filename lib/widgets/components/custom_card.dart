...
// Score Card - Specific for displaying AI scores
...
class LeaderboardCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tierBaseColor = _getTierBaseColor();
    ...
    return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isCurrentUser
                  ? AppColors.primaryNeonOrange.withOpacity(0.5)
        ...
        .shimmer(duration: 2000.ms, color: tierColor.withOpacity(0.1));
  }
